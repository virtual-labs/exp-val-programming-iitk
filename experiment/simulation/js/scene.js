...
// camera
        ...
        this.camera.position.set(600, -200, 1700);   //
...
//create link1
        ...
        link1Mesh = new THREE.Mesh(link1, new THREE.MeshNormalMaterial({color: "grey"}));
...
//create Link2
        ...
        this.link2Mesh = new THREE.Mesh(link2, new THREE.MeshNormalMaterial());
...
//Link3
        ...
        this.Link3Mesh = new THREE.Mesh(Link3, new THREE.MeshNormalMaterial({color: "blue"}));
        ...
        this.Link4Mesh = new THREE.Mesh(Link4, new THREE.MeshNormalMaterial({color: "lightgreen", transparent: false, blending: THREE.AdditiveBlending}));
        this.Link4Mesh.position.set(0, 310, 0);
        this.Link3Mesh.add(this.Link4Mesh);

        // Create Link 5
        Box2L5 = new THREE.Mesh(new THREE.BoxGeometry(60.05, 5, 85.95), new THREE.MeshNormalMaterial());
        Box2L5.position.set(-70, 181, 0);
        this.Link4Mesh.add(Box2L5);

        this.BoxL5 = new THREE.Mesh(new THREE.BoxGeometry(60, 40, 80), new THREE.MeshNormalMaterial());
        this.BoxL5.position.set(0, 22, 0);
        Box2L5.add(this.BoxL5);

        Cylinder2L5 = new THREE.Mesh(new THREE.CylinderGeometry(40, 40, 20, 100), new THREE.MeshNormalMaterial());
        ...
        this.Cylinder4L5 = new THREE.Mesh(new THREE.CylinderGeometry(40, 40, 20, 100), new THREE.MeshNormalMaterial());
        this.Cylinder4L5.position.set(20, 50, 0);
        this.Cylinder4L5.rotation.z += Math.PI / 2;
        this.BoxL5.add(this.Cylinder4L5);

        Cylinder5L5 = new THREE.Mesh(new THREE.CylinderGeometry(20, 20, 60, 10), new THREE.MeshNormalMaterial());
        this.BoxL5.add(Cylinder5L5);
        Cylinder5L5.rotation.z += Math.PI / 2;
        Cylinder5L5.position.set(0, 20, 20);

        Cylinder6L5 = new THREE.Mesh(new THREE.CylinderGeometry(20, 20, 60, 10), new THREE.MeshNormalMaterial());
        this.BoxL5.add(Cylinder6L5);
        Cylinder6L5.rotation.z += Math.PI / 2;
        Cylinder6L5.position.set(0, 20, -20);

        // create Link 6
        this.CylinderL6 = new THREE.Mesh(new THREE.CylinderGeometry(12, 12, 50, 100), new THREE.MeshNormalMaterial({color: "black"}));
        this.Cylinder3L5.add(this.CylinderL6);
        this.CylinderL6.position.set(35, 0, 0);
        this.CylinderL6.rotation.z -= Math.PI / 2;

        Cylinder2L6 = new THREE.Mesh(new THREE.CylinderGeometry(20, 20, 10, 100), new THREE.MeshNormalMaterial({color: "black"}));
        this.CylinderL6.add(Cylinder2L6);
        Cylinder2L6.position.set(0, 20, 0);
        //this.CylinderL6.rotation.z -= Math.PI / 2;

        BoxL6 = new THREE.Mesh(new THREE.BoxGeometry(50, 5, 50), new THREE.MeshNormalMaterial({color: "black"}));
        BoxL6.position.set(0, 20, 0);
        this.CylinderL6.add(BoxL6);

        Box2L6 = new THREE.Mesh(new THREE.BoxGeometry(50, 3, 50), new THREE.MeshNormalMaterial({color: "black"}));
        Box2L6.position.set(24, 23, 0);
        Box2L6.rotation.z += Math.PI / 2;
        BoxL6.add(Box2L6);

        Box3L6 = new THREE.Mesh(new THREE.BoxGeometry(50, 3, 50), new THREE.MeshNormalMaterial({color: "black"}));
